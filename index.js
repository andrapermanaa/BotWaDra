...
/////////////////
const BotName = 'Ndra BOT☄'; 
const instagram = 'https://instagram.com/ff.ndra10'; 
const telegram = '-'; 
const kapanbotaktif = 'SELALU AKTIF'; 
const youtube = 'https://www.youtube.com/c/YT NDRA10';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@ff.ndra10')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@ff.ndra10`)
})
